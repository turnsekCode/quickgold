...
// Exports
module.exports = {
	"contenedorSectionUno": "section_uno_contenedorSectionUno__ZW_iJ",
	"contenedorTexto": "section_uno_contenedorTexto__EdO9w",
	"titulo": "section_uno_titulo__U36G8",
	"texto": "section_uno_texto__D1kcn"
};
...
// Exports
module.exports = {
	"contenedorSectionDos": "sectionDos_contenedorSectionDos__dlqNa",
	"TituloSectionDos": "sectionDos_TituloSectionDos__0_BwT",
	"textoSectionDos": "sectionDos_textoSectionDos__blV_G",
	"select": "sectionDos_select__1LJQm",
	"lineaAdorno": "sectionDos_lineaAdorno__WVqgA"
};
...
// EXTERNAL MODULE: ./src/componentes/ComponenteMapaTiendas/Section_1/section_uno.module.css
var section_uno_module = __webpack_require__(5564);
var section_uno_module_default = /*#__PURE__*/__webpack_require__.n(section_uno_module);
;// CONCATENATED MODULE: ./src/componentes/ComponenteMapaTiendas/Section_1/Section_uno.js
...
// EXTERNAL MODULE: ./src/componentes/ComponenteMapaTiendas/Section_2/sectionDos.module.css
var sectionDos_module = __webpack_require__(3503);
...
;// CONCATENATED MODULE: ./src/componentes/ComponenteMapaTiendas/Section_2/Section_dos.js
...
;// CONCATENATED MODULE: ./src/pages/tiendas/index.js
...
async function getStaticProps() {
    ...
    const alcaladehenares_ = await fetch(`https://panel.quickgold.es/markers${idAlcladehenares}.json`);
    const alcaladehenares = await alcaladehenares_.json();
    const alcobendas_ = await fetch(`https://panel.quickgold.es/markers${idAlcobendas}.json`);
    const alcobendas = await alcobendas_.json();
    const alcorcon_ = await fetch(`https://panel.quickgold.es/markers${idAlcorcon}.json`);
    const alcorcon = await alcorcon_.json();
    const alicante_ = await fetch(`https://panel.quickgold.es/markers${idAlicante}.json`);
    const alicante = await alicante_.json();
    const almeria_ = await fetch(`https://panel.quickgold.es/markers${idAlmeria}.json`);
    const almeria = await almeria_.json();
    const barcelona_ = await fetch(`https://panel.quickgold.es/markers${idBarcelona}.json`);
    const barcelona = await barcelona_.json();
    const benidorm_ = await fetch(`https://panel.quickgold.es/markers${idBenidorm}.json`);
    const benidorm = await benidorm_.json();
    const bilbao_ = await fetch(`https://panel.quickgold.es/markers${idBilbao}.json`);
    const bilbao = await bilbao_.json();
    const cadiz_ = await fetch(`https://panel.quickgold.es/markers${idCadiz}.json`);
    const cadiz = await cadiz_.json();
    const cartagena_ = await fetch(`https://panel.quickgold.es/markers${idCartagena}.json`);
    const cartagena = await cartagena_.json();
    const castellon_ = await fetch(`https://panel.quickgold.es/markers${idCastellon}.json`);
    const castellon = await castellon_.json();
    const cordoba_ = await fetch(`https://panel.quickgold.es/markers${idCordoba}.json`);
    const cordoba = await cordoba_.json();
    const elche_ = await fetch(`https://panel.quickgold.es/markers${idElche}.json`);
    const elche = await elche_.json();
    const getafe_ = await fetch(`https://panel.quickgold.es/markers${idGetafe}.json`);
    const getafe = await getafe_.json();
    const gijon_ = await fetch(`https://panel.quickgold.es/markers${idGijon}.json`);
    ...
    const logrono_ = await fetch(`https://panel.quickgold.es/markers${idLogrono}.json`);
    const logrono = await logrono_.json();
    const madrid_ = await fetch(`https://panel.quickgold.es/markers${idMadrid}.json`);
    const madrid = await madrid_.json();
    const malaga_ = await fetch(`https://panel.quickgold.es/markers${idMalaga}.json`);
    const malaga = await malaga_.json();
    const marbella_ = await fetch(`https://panel.quickgold.es/markers${idMarbella}.json`);
    const marbella = await marbella_.json();
    const murcia_ = await fetch(`https://panel.quickgold.es/markers${idMurcia}.json`);
    const murcia = await murcia_.json();
    const oviedo_ = await fetch(`https://panel.quickgold.es/markers${idOviedo}.json`);
    const oviedo = await oviedo_.json();
    const palma_ = await fetch(`https://panel.quickgold.es/markers${idPalma}.json`);
    const palma = await palma_.json();
    const roquetasdemar_ = await fetch(`https://panel.quickgold.es/markers${idRoquetasDeMar}.json`);
    ...
    const santacruz_ = await fetch(`https://panel.quickgold.es/markers${idSantaCruz}.json`);
    const santacruzdetenerife = await santacruz_.json();
    const santander_ = await fetch(`https://panel.quickgold.es/markers${idSantander}.json`);
    const santander = await santander_.json();
    const santiago_ = await fetch(`https://panel.quickgold.es/markers${idSantiago}.json`);
    const santiagodecompostela = await santiago_.json();
    const sevilla_ = await fetch(`https://panel.quickgold.es/markers${idSevilla}.json`);
    const sevilla = await sevilla_.json();
    const tarragona_ = await fetch(`https://panel.quickgold.es/markers${idTarragona}.json`);
    const tarragona = await tarragona_.json();
    const tenerife_ = await fetch(`https://panel.quickgold.es/markers${idTenerife}.json`);
    const tenerife = await tenerife_.json();
    const valencia_ = await fetch(`https://panel.quickgold.es/markers${idValencia}.json`);
    const valencia = await valencia_.json();
    const valladolid_ = await fetch(`https://panel.quickgold.es/markers${idValladolid}.json`);
