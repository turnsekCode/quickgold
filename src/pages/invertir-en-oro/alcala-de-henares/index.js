...
import SeccionUno from "@/componentes/ComponentesTiendaIndividualInvertirEnOro/SeccionUno/SeccionUno";
import SeccionTres from "@/componentes/ComponentesTiendaIndividualInvertirEnOro/SeccionTres/SeccionTres";
...
import SeccionDos from "@/componentes/ComponentesTiendaIndividualInvertirEnOro/seccionDos/SeccionDos";
  ...
  return (
    <>
      <SEO
        ...
        description={
          ciudad?.acf?.invertir_en_oro_grupo?.description_meta_invertir
        }
        icon="/favicon.png"
        facebook={{
          image: `/assets/img/${ciudad?.acf?.info_grupo?.tienda}.jpg`,
